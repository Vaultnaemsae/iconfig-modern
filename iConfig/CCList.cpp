...
const QStringList &CCList()
{
    ...
    if (!initialized) {
        ...
        cclist << QString("48 - General Purpose Controller 1 (fine)");
        cclist << QString("49 - General Purpose Controller 2 (fine)");
        cclist << QString("50 - General Purpose Controller 3 (fine)");
        cclist << QString("51 - General Purpose Controller 4 (fine)");
        ...
        cclist << QString("66 - Sostenuto Pedal on/off");
        ...
        cclist << QString("80 - General Purpose Controller 5");
        cclist << QString("81 - General Purpose Controller 6");
        cclist << QString("82 - General Purpose Controller 7");
        cclist << QString("83 - General Purpose Controller 8");
        cclist << QString("84 - Portamento Control");
        cclist << QString("85 - Undefined on/off");
        cclist << QString("86 - Undefined on/off");
        cclist << QString("87 - Undefined on/off");
        cclist << QString("88 - High Resolution Velocity Prefix");
        cclist << QString("89 - Undefined on/off");
        cclist << QString("90 - Undefined on/off");
        cclist << QString("91 - Effects 1 Depth (Reverb Send Level)");
        cclist << QString("92 - Effects 2 Depth (Tremolo)");
        cclist << QString("93 - Effects 3 Depth (Chorus Send Level)");
        cclist << QString("94 - Effects 4 Depth (Celeste/Detune)");
        cclist << QString("95 - Effects 5 Depth (Phaser)");
        cclist << QString("96 - Data entry +1");
        cclist << QString("97 - Data entry -1");
        cclist << QString("98 - Non-Registered Parameter Number (NRPN) LSB");
        cclist << QString("99 - Non-Registered Parameter Number (NRPN) MSB");
        cclist << QString("100 - Registered Parameter Number (RPN) LSB");
        cclist << QString("101 - Registered Parameter Number (RPN) MSB");
        ...
        cclist << QString("121 - Reset All Controllers");
        cclist << QString("122 - Local Control On/Off");
